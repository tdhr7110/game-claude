...
export function PrepScreen() {
  ...
  const selectedCost = selected
    ...
    : undefined;
  const activeSynergyCount = Object.values(synergies.partType).reduce((n, g) => n + g.activeTiers.length, 0) +
    ...
    <div className="section-card">
      ...
      <div className="prep-status-grid">
        <div className="prep-status-tile">
          <div className="prep-status-tile__value">{capacityUsed} / {capacityTotal}</div>
