...
// キメラ図鑑タブの中身。以前は単独のモーダルだったが、TEST15で部位図鑑・敵図鑑と
// 統合した CollectionModal のタブの1つになった(モーダルの外枠・開閉はCollectionModal側が持つ)。
export function ChimeraGalleryTab() {
  const { collection } = useGame();
  const chimeraGallery = collection.chimeras;
